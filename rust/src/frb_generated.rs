...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -980236252;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__db_api__get_dashboard_stats_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__db_api__get_paciente_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__db_api__get_sesion_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__import_api__import_pacientes_from_excel_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        14 => wire__crate__api__db_api__init_database_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__db_api__list_pacientes_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__photos_api__list_photos_by_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__db_api__list_sesiones_by_paciente_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__db_api__list_tratamientos_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__backup_api__restore_backup_impl(port, ptr, rust_vec_len, data_len),
        20 => {
            wire__crate__api__photos_api__save_session_photo_impl(port, ptr, rust_vec_len, data_len)
        }
        21 => wire__crate__api__db_api__update_paciente_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__db_api__update_sesion_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__db_api__update_tratamiento_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
